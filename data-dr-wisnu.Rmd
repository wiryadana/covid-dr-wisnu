...
interaction3 <- ggplot(data = data, aes(x=Umur, y=Derajat_new)) +
  geom_jitter(height=0.15, alpha=0.7, aes(shape=Derajat_new,  colour=Komorbid_DM, fill=Komorbid_HT), show.legend = F) +
...
interaction3 + annotation_custom(grob = grob3b, xmin = xmin, xmax = xmax, ymin = 0.0 , ymax = 3.3)
```
